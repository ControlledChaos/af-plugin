...
$settings_icon = sanitize_text_field( get_option( 'afp_site_settings_link_icon' ) );
...
$tabs = [
    ...
    sprintf(
        ...
        '#intro',
        esc_html__( 'Introduction', 'af-plugin' )
	),
    ...
    sprintf(
		...
		'#settings',
		esc_attr( $settings ),
        esc_html__( 'Site Settings', 'af-plugin' )
	),
    ...
    sprintf(
        ...
        '#scripts',
        esc_html__( 'Script Options', 'af-plugin' )
	),
    ...
    sprintf(
        ...
        '#media',
        esc_html__( 'Media Options', 'af-plugin' )
	),
    ...
    sprintf(
        '<li><a href="%1s"><span class="dashicons dashicons-welcome-learn-more"></span> %2s</a></li>',
        '#tools',
        esc_html__( 'Development Tools', 'af-plugin' )
    ),

];

// Apply a filter to the tabs array for adding tabs.
$page_tabs = apply_filters( 'afp_tabs_page_about', $tabs );
...
<div class="wrap site-plugin-wrap">
	...
	<div class="backend-tabbed-content">
		...
		do_action( 'afp_content_page_about_before' ); ?>
		<!-- Begin content -->
		<div id="intro"><!-- Introduction content -->
			<?php include_once AFP_PATH . 'admin/partials/plugin-page-intro.php'; ?>
		</div>
		<div id="settings"><!-- Site Settings content -->
			<?php include_once AFP_PATH . 'admin/partials/plugin-page-site-settings.php'; ?>
		</div>
		<div id="scripts"><!-- Script Options content -->
			<?php include_once AFP_PATH . 'admin/partials//plugin-page-script-options.php'; ?>
		</div>
		<div id="media"><!-- Media Options content -->
			<?php include_once AFP_PATH . 'admin/partials/plugin-page-media-options.php'; ?>
		</div>
		<div id="tools"><!-- Dev Tools content -->
			<?php include_once AFP_PATH . 'admin/partials/plugin-page-dev-tools.php'; ?>
		</div>
		<?php // Hook for adding tabbed content.
		do_action( 'afp_content_page_about_after' ); ?>
