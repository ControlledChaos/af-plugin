...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( afp_acf_options() ) {
            ...
            $options = get_field( 'afp_admin_hide_links', 'option' );
    ...
    public function hide() {
        ...
        if ( afp_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'afp_hide_appearance' );
            $plugins    = get_option( 'afp_hide_plugins' );
            $users      = get_option( 'afp_hide_users' );
            $tools      = get_option( 'afp_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( afp_acf_options() ) {
            ...
            $menus_link   = get_field( 'afp_menus_position', 'option' );
            $widgets_link = get_field( 'afp_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'afp_menus_position' );
            $widgets_link = get_option( 'afp_widgets_position' );
