			...
			acf_add_local_field_group( [
				...
				'fields' => [
					...
					[
						...
						'choices'           => [
							'gutenberg' => __( 'Try Gutenberg', 'af-plugin' ),
							'welcome'   => __( 'Welcome', 'af-plugin' ),
							'news'      => __( 'WordPress News', 'af-plugin' ),
							'quick'     => __( 'Quick Press', 'af-plugin' ),
							'at_glance' => __( 'At a Glance', 'af-plugin' ),
							'activity'  => __( 'Activity', 'af-plugin' ),
						],
						'allow_custom'      => 0,
						'save_custom'       => 0,
						'default_value'     => [],
					...
					[
						...
						'label'             => __( 'Restore Links Manager', 'af-plugin' ),
						'name'              => 'afp_links_manager',
						'type'              => 'true_false',
						'instructions'      => __( 'The old Links Manager is hidden by default in newer WordPress installations.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'default_value'     => 0,
						'ui'                => 1,
						'ui_on_text'        => __( 'Enabled', 'af-plugin' ),
						'ui_off_text'       => __( 'Disabled', 'af-plugin' ),
					],
					...
					[
						...
						'label'             => __( 'Classic Editor', 'af-plugin' ),
						'name'              => 'afp_classic_editor',
						'type'              => 'true_false',
						'instructions'      => __( 'Disables the block editor (a.k.a. Gutenberg) and restores the TinyMCE editor.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'message'           => __( 'Use the classic editor', 'af-plugin' ),
						'default_value'     => 0,
						'ui'                => 1,
					...
					[
						...
						'label'             => __( 'Admin Footer Credit', 'af-plugin' ),
						'name'              => 'afp_admin_footer_credit',
						'type'              => 'text',
						'instructions'      => __( 'The "developed by" credit.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
					...
					[
						...
						'label'             => __( 'Admin Footer Link', 'af-plugin' ),
						'name'              => 'afp_admin_footer_link',
						'type'              => 'url',
						'instructions'      => __( 'Link to the website devoloper.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
					...
					[
						...
						'label'             => __( 'Meta Tags', 'af-plugin' ),
						'name'              => 'afp_meta_disable_tags',
						'type'              => 'true_false',
						'instructions'      => __( 'Disable if you plan on using Yoast SEO or a similarly awful plugin.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
						...
						'message'           => __( 'Check to disable', 'af-plugin' ),
						'default_value'     => 0,
						'ui'                => 0,
						'ui_on_text'        => __( 'Disabled', 'af-plugin' ),
						'ui_off_text'       => __( 'Enabled', 'af-plugin' ),
					],
					[
						'key'               => 'field_5a198d601b523',
						'label'             => __( 'Blog Pages Title', 'af-plugin' ),
						'name'              => 'afp_meta_blog_title',
						'type'              => 'text',
						'instructions'      => __( 'Will use the site title if left empty.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => [
							[
								[
					...
					[
						...
						'label'             => __( 'Blog Pages Description', 'af-plugin' ),
						'name'              => 'afp_meta_blog_description',
						'type'              => 'textarea',
						'instructions'      => __( 'Will use the site tagline if left empty and if a tagline is set.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => [
							[
								[
					...
					[
						...
						'label'             => __( 'Blog Pages Image', 'af-plugin' ),
						'name'              => 'afp_meta_blog_image',
						'type'              => 'image',
						'instructions'      => __( 'A minimum of 1230px by 600px is recommended for retina display devices.', 'af-plugin' ),
						'required'          => 0,
						'conditional_logic' => [
							[
								[
