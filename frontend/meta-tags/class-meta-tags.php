...
class Meta_Tags {
	...
	public function dependencies() {
		...
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-url.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-title.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-description.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-author.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-date-published.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-date-modified.php';
		include_once AFP_PATH . 'frontend/meta-tags/class-meta-image.php';
