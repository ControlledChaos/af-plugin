...
class AFP_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once AFP_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once AFP_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['afp-custom-beaver-field'] = AFP_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'afp-beaver-fields', AFP_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'afp-beaver-fields', AFP_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$afp_beaver_builder = new AFP_Beaver_Builder;