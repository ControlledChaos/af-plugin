...
namespace AF_Plugin\Includes\Media;
...
class Media {
	...
	private function dependencies() {
		...
		include_once AFP_PATH . 'includes/media/class-svg-support.php';

		// Replace WP gallery shortcode if Fancybox option is used.
		$fancybox = get_option( 'afp_enqueue_fancybox_script' );

		if ( $fancybox ) {
			require_once AFP_PATH . 'includes/media/class-gallery-shortcode.php';
		}
	...
	public function image_sizes() {
		 ...
		 */
		add_image_size( __( 'column-thumbnail', 'af-plugin' ), 48, 48, true );
	...
	public function rss_featured_images( $content ) {
		...
		$size = apply_filters( 'afp_rss_featured_image_size', 'medium' );
