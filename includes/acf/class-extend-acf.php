...
namespace AF_Plugin\Includes\ACF;
...
class Extend_ACF {
	...
	public function include_fields() {
		...
		include_once AFP_PATH . 'includes/acf/fields/acf-sample-field/class-acf-sample-field.php';

		include_once AFP_PATH . 'includes/acf/acf-field-name/acf-field-name.php';
	...
	public function admin_styles() {
		...
		// wp_enqueue_style( AFP_ADMIN_SLUG . '-acf-admin', AFP_URL . 'includes/acf/assets/css/admin.min.css', [], AFP_VERSION, 'screen' );
	...
	public function admin_scripts() {
		...
		// Uncomment to enqueue.
		// wp_enqueue_script( AFP_ADMIN_SLUG . '-acf-admin', AFP_URL . 'includes/acf/assets/js/admin.min.js', [ 'jquery' ], AFP_VERSION, true );
